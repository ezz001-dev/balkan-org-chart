...
(OrgChart._defaultConfig = function (t) {
                        ...
                        if (!a.notifierUI.show(t.notif)) {
                            ...
                            if ((OrgChart.events.publish("render", [a, n]), (o = n.content), (t = n.res), (o += a.ui.lonely(a.config)), e !== OrgChart.action.exporting)) {
                                ...
                                e === OrgChart.action.centerNode
                                    ...
                                    ? 0 == C[0].length && (m || (i && i(), OrgChart.events.publish("redraw", [a]), (m = !0)))
    ...
    (OrgChart.prototype.moveNodesToVisibleArea = function (t, e) {
        ...
        if (m - 2 * this.config.padding >= n - l) O = (n + l) / 2 - m / 2;
            ...
            switch (((O = firstRoot.x - m / 2 + OrgChart.manager._getNodeWidth(firstRoot, this.config) / 2), this.config.orientation)) {
        ...
        if (C - 2 * this.config.padding >= o - s) b = (o + s) / 2 - C / 2;
            ...
            switch (((b = -(C / 2 - (o - s) / 2)) > -this.config.padding && (b = -this.config.padding), this.config.orientation)) {
        ...
        var v = [O, b, m, C];
        a[0] !== v[0] || a[1] !== v[1]
            ? OrgChart.animate(i, { viewBox: a }, { viewBox: v }, this.config.anim.duration, this.config.anim.func, function () {
            ...
            if (OrgChart.isNEU(p) || p.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id) != t) {
                ...
                u.menu)) {
                    ...
                    if ((A.setAttribute("pointer-events", "none"), A)) {
                        ...
                        A.setAttribute("x", -L / 2), A.setAttribute("y", -E / 2);
                    }
                    var N = (m * Math.PI) / (C / 2);
                    m++;
                    var M = Math.cos(N) * O,
    ...
    (OrgChart.prototype.exportPDF = function (t, e) {
        // console.log("export  pdf here ===> " , t,e)
    ...
    (OrgChart.prototype._defaultExportOptions = function (t, e) {
        console.log("_defaultExportOptions ==> " , t,e)
        return (
            null == t && (t = {}),
    ...
    (OrgChart.prototype._pagesA100 = function (t, e, r, i) {
        ...
        var l = a[0],
            ...
            h = a[2],
            d = a[3],
            c = { w: t.landscape ? o - (t.margin[1] + t.margin[3]) : n - (t.margin[1] + t.margin[3]), h: t.landscape ? n - (t.margin[0] + t.margin[2]) : o - (t.margin[0] + t.margin[2]) },
        ...
        if (!OrgChart.EXPORT_PAGES_CUT_NODES && "fit" == t.scale) {
            ...
            for (var b = Object.keys(i.bordersByRootIdAndLevel), v = i.bordersByRootIdAndLevel[b[0]], y = Object.keys(v).length, x = 1; x < b.length; x++)
                y < Object.keys(i.bordersByRootIdAndLevel[b[x]]).length && ((v = i.bordersByRootIdAndLevel[b[x]]), (y = Object.keys(v).length));
            for (var _ = 0, w = 0; ; ) {
                for (w = _; !(y <= _); ) {
                ...
                if (((I = (I = [f, v[w].minY, p, S]).join()), C.push({ vb: I, innerSize: { w: c.x, h: S / (100 / r) - 1 }, size: g }), _ == y)) break;
                _--;
            }
    ...
    (OrgChart.prototype._defaultExportProfileOptions = function (t, e) {
        return (
            OrgChart.isNEU(t) || null == t.id || null != t.nodeId || (t.nodeId = t.id),
    ...
    (OrgChart.prototype._nodeCircleNodeMenuItemMouseDownHandler = function (t, e, r) {
        ...
        if (n.draggable) {
            ...
            u.setAttribute("transform", "matrix(1,0,0,1," + (m + O.x) + "," + (C + O.y) + ")"), (u.style.opacity = 0.7);
            var b = function (t, e) {
                    if (null != t) {
                ...
                y = function (e) {
                    ...
                    var i = o.getNode(d);
                    OrgChart.events.publish("drop", [o.nodeCircleMenuUI, { from: s.id, to: i.id, menuItem: n, menuItemName: a, event: e }]), b(d, c), g.removeChild(u), (o._gragStartedId = null);
                };
    ...
    (OrgChart.prototype._movableHandler = function (t, e, r) {
            ...
            E = function (e) {
                if (I) {
                    ...
                    var l = OrgChart._getOffsetXY(i.element, e),
                        d = { left: i.width() - (l.x + i.config.padding) < 0, right: l.x - i.config.padding < 0, up: i.height() - (l.y + i.config.padding) < 0, down: l.y - i.config.padding < 0 };
                    if (d.left || d.right || d.up || d.down) {
                        ...
                        if (!t._dragEventFired && (Math.abs(r.x - I.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - I.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)) {
                            if ((!1 === OrgChart.events.publish("drag", [i, a, e, n]) && N(), i.config.enableDragDrop)) for (_ = 0; _ < f.length; _++) h.insertBefore(f[_], h.firstChild);
                            t._dragEventFired = !0;
                        }
        ...
        h.addEventListener(r.move, E), h.addEventListener(r.up, N), r.leave && h.addEventListener(r.leave, N);
    }),
            ...
            C = function (e) {
                if (d) {
                    ...
                    if (C.left || C.right || C.up || C.down) {
                        ...
                        var E = (r.x - d.x) / u,
                            N = (r.y - d.y) / u;
                        if (((c[4] = g + E), (c[5] = p + N), !t._dragEventFired && (Math.abs(r.x - d.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - d.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)))
                    ...
                    s._read(function (t) {
                        ...
                        (i.notif = t.limit),
                            ...
                            a != OrgChart.action.exporting &&
                                ((s.maxX = d), (s.maxY = c), (s.minX = g), (s.minY = p), (s.roots = f), (s.nodes = m), (s.visibleNodeIds = i.visibleNodeIds), (s.bordersByRootIdAndLevel = u), (s.rootList = t.rootList)),
                            o(i);
                    }, l);
        });
    }),
    ...
    (OrgChart.manager._setCollpasedProperty = function (t, e, r, i, a, n, o) {
        null == t.collapsed && e.collapse && e.collapse.allChildren ? (t.collapsed = !0) : null == t.collapsed && (t.collapsed = !1),
            ...
            a == OrgChart.action.init && null != o
                ...
                ? -1 != t.tags.indexOf("left-partner") || -1 != t.tags.indexOf("right-partner") || -1 != t.tags.indexOf("partner") || t.parentPartner
                    ? (t.collapsed = e.collapse && n >= e.collapse.level && -1 == i.indexOf(t.id))
    ...
    (OrgChart.manager._createNodes = function (t) {
        ...
        if (i == OrgChart.action.init && e.expand && e.expand.nodes && null == o)
            ...
            for (d = 0; d < it.length; d++) for (var O = l[(C = l[it[d]]).pid]; O; ) m.push(O.id), null == O.pid && null != O.stpid ? ((O = l[O.stpid]).min = !1) : (O = l[O.pid]);
        ...
        for (d = 0; d < S.length; d++) {
            ...
            for (v = 0; v < C.children.length; v++) {
                (H = C.children[v]).isAssistant
                    ...
                    : -1 == H.tags.indexOf("partner") || N % 2
                    ? -1 != H.tags.indexOf("partner") && N % 2
                        ? ((H.isPartner = 2), (H.children = []), L.push(H.id), N++)
                        : H.parentPartner
                        ? (E[H.parentPartner.id] || (E[H.parentPartner.id] = []), E[H.parentPartner.id].push(H.id))
                        : I.push(H.id)
                    : ((H.isPartner = 1), (H.children = []), A.push(H.id), N++);
            }
            C.children = [];
            var R = [];
            ...
            for (v = L.length - 1; v >= 0; v--) if (E[L[v]]) for (f = 0; f < E[L[v]].length; f++) C.children.push(l[E[L[v]][f]]), M++, -1 == U.indexOf(L[v]) && U.push(L[v]);
            for (v = 0; v < I.length; v++) {
                var H = l[I[v]];
                C.children.push(H);
            }
            for (v = 0; v < A.length; v++) if (E[A[v]]) for (f = 0; f < E[A[v]].length; f++) C.children.push(l[E[A[v]][f]]), T++, -1 == B.indexOf(A[v]) && B.push(A[v]);
        ...
        for (d = 0; d < w.length; d++) {
            ...
            for (v = 0; v < C.subLevels; v++) {
                ...
                if ((OrgChart.manager._initDinamicNode(z, C.lcn), (O = C.parent)))
                    (ft = O.children.indexOf(C)) > -1 && (O.children.splice(ft, 1), O.children.splice(ft, 0, z)), z.children.push(C), (z.parent = O), (C.parent = z), (l[z.id] = z);
            }
        }
        for (var j in _) {
            ...
            if (Y.length % 2) {
                ...
                OrgChart.manager._initDinamicNode(X, q.lcn, !0), (X.isAssistant = !0), (X.w = q.w), (X.h = q.h), (l[X.id] = X), Y.splice(Y.length - 1, 0, X.id);
            }
            var $ = 1;
            ...
            for (var j in k) {
                ...
                if (0 != (D = r[O.lcn ? O.lcn : "base"]).layout || tt) {
                    (et.pnode = O),
                        ...
                        et.layouts.length || et.layouts.push({ layout: et.layout, childrenIds: et.childrenIds, subLevels: et.subLevels, layoutGridColumns: et.layoutGridColumns });
                    for (var gt = 0; gt < et.layouts.length; gt++) {
                        ...
                        if (pt.subLevels) {
                            for (v = 0; v < pt.childrenIds.length; v++) {
                                ...
                                -1 != (ft = O.children.indexOf(H)) && O.children.splice(ft, 1), (H.parent = ut), ut.children.push(H);
                            }
                            O = ut;
                        }
                            ...
                            for (d = 0; d < pt.childrenIds.length; d += Ct) {
                                ...
                                for (v = 0; v < Ct; v++) {
                                    ...
                                    ((H = l[(ht = pt.childrenIds[d + v])]).parent = l[mt]),
                                        ...
                                        bt ||
                                            (Ct / 2 - 1 == v &&
                                                ((Ot = new OrgChart.node(pt.childrenIds[d + v - 1] + "_grid_pseudo_node_" + pt.childrenIds[d + v + 1], mt, [], "subLevel")),
                        ...
                        if (pt.layout == OrgChart.layout.mixed) {
                            ...
                            for (v = 0; v < xt.length; v += 3) {
                                ...
                                0 != v && (G = l[xt[v - 3]]),
                                    ...
                                    (W.parent = G),
                                    G.children.push(W),
                                    J && (0 != v && (G = l[xt[v - 2]]), (J.parent = G), G.children.push(J)),
                                    K && (0 != v && (G = l[xt[v - 1]]), (K.parent = G), G.children.push(K));
                            }
                        }
                    }
                }
    ...
    (OrgChart.manager._setMinMaxXYAdjustifyIterate = function (t, e, r, i, a, n, o, l) {
        ...
        t.isPartner ? (t.sl = i - 1) : (t.sl = i),
            ...
            t.layout ? (null == l[e.id] && (l[e.id] = {}), null == l[e.id][t.sl] && (l[e.id][t.sl] = t)) : OrgChart._setMinMaxXY(t, a[e.id][t.sl]),
                    ...
                    (b = t.children[C]).parentPartner
                        ? ((m.ppnodes[b.id] = b.parentPartner),
                          ...
                          1 == b.parentPartner.isPartner
                              ? (-1 == m.rightIds.indexOf(b.parentPartner.id) && m.rightIds.push(b.parentPartner.id), (m.indexes[b.id] = m.rightIds.indexOf(b.parentPartner.id)), m.firstRight || (m.firstRight = b))
                              : 2 == b.parentPartner.isPartner && (-1 == m.leftIds.indexOf(b.parentPartner.id) && m.leftIds.push(b.parentPartner.id), (m.indexes[b.id] = m.leftIds.indexOf(b.parentPartner.id)), (m.lastLeft = b)))
                        : b.isPartner || ((m.lastLeft = b), m.firstRight || (m.firstRight = b));
                }
            ...
            for (C = 0; C < t.children.length; C++) {
                ...
                if (S) (O = S), (x = x.replaceAll("{rounded}", S).replaceAll("{edge}", S).replaceAll("{curve}", O));
                    ...
                    if ((y.xa == y.xb && y.xa == y.xc && y.xa == y.xd) || (y.ya == y.yb && y.ya == y.yc && y.ya == y.yd)) (O = "M" + y.xa + "," + y.ya + " L" + y.xd + "," + y.yd), (x = x.replaceAll("{rounded}", O));
                        ...
                        (O = "M" + y.xa + "," + y.ya + " L" + y.xa + "," + y.yd), (x = x.replaceAll("{rounded}", O));
                        ...
                        (O = "M" + y.xa + "," + y.ya + " L" + y.xd + "," + y.ya), (x = x.replaceAll("{rounded}", O));
                    else {
                    ...
                    -1 != x.indexOf("{edge}")
                        ? ((O = "M" + y.xa + "," + y.ya + " " + y.xb + "," + y.yb + " " + y.xc + "," + y.yc + " L" + y.xd + "," + y.yd), (x = x.replaceAll("{edge}", O)))
                        : -1 != x.indexOf("{curve}")
                        ? ((O = "M" + y.xa + "," + y.ya + " C" + y.xb + "," + y.yb + " " + y.xc + "," + y.yc + " " + y.xd + "," + y.yd), (x = x.replaceAll("{curve}", O)))
                        : ((O = x.replaceAll("{xa}", y.xa).replaceAll("{ya}", y.ya).replaceAll("{xb}", y.xb).replaceAll("{yb}", y.yb).replaceAll("{xc}", y.xc).replaceAll("{yc}", y.yc).replaceAll("{xd}", y.xd).replaceAll("{yd}", y.yd)),
                          (x = O));
                d.push(
                ...
                OrgChart.events.publish("render-link", [e, L]), d.push(L.html), o && c.push({ id: t.id, childId: b.id, html: L.html });
                var E = "";
                for (var N in e.config.linkBinding) {
                    ...
                    if (T) {
                        var B = T[M];
                        (L.value = B), (L.element = h[N]), (L.name = M), !1 !== OrgChart.events.publish("label", [e, L]) && (OrgChart.isNEU(L.value) || OrgChart.isNEU(L.element) || (E += L.element.replace("{val}", L.value)));
                    }
                }
                if ("" != E) {
                    var U = y.x,
                        R = y.y;
                    null != b.movey && (R += b.movey), (E = OrgChart.linkFieldsOpenTag.replace("{x}", U).replace("{y}", R).replace("{rotate}", 0) + E + OrgChart.grCloseTag), d.push(E);
                }
    ...
    (OrgChart.prototype._slinks = function (t, e) {
        ...
        function n(e, n, o) {
            ...
            for (var E = 1; E < s.length; E++) s[E].unshift("L");
            ...
            o && ((U = n.id), (R = e.id)),
                (r +=
                    ("<g " + OrgChart.attr.s_link_from + '="{from}" ' + OrgChart.attr.s_link_to + '="{to}">').replace("{from}", U).replace("{to}", R) +
    ...
    (OrgChart.elements.multiSelect = function (t, e, r, i) {
        ...
        return a.doNotRender
            ...
            : {
                  html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${a.disabledAttribute} ${a.vlidators}>\n                        <label for="${
                      a.id
                  }">${OrgChart._escapeGreaterLessSign(a.label)}</label>\n                        <select class="multiple" data-binding="${OrgChart._escapeDoubleQuotes(a.binding)}" ${a.readOnlyAttribute} id="${a.id}" name="${
                      a.id
                  }" multiple>\n                            ${(function () {
                      for (var t = "", e = 0; e < a.options.length; e++) {
                          var r = a.options[e];
    ...
    (OrgChart.filterUI.prototype.update = function () {
        if (this.instance.config.filterBy) {
            ...
            for (var s in this.filterBy) {
                var f = { name: s, html: `<div data-filter-field="${s}">${s}</div>` };
                ...
                this.element.addEventListener("click", function (t) {
                    if (t.target.hasAttribute("data-filter-close") || t.target.hasAttribute("data-filter-field")) {
                                    ...
                                    if (e) {
                                        ...
                                        if (t.target.hasAttribute("data-all")) {
                                            for (var i = t.target.parentNode.parentNode.querySelectorAll("input"), a = 0; a < i.length; a++)
                                                if (i[a] != t.target) for (var n in ((i[a].checked = t.target.checked), p.filterBy[r])) p.filterBy[r][n].checked = t.target.checked;
                        ...
                        (o.style.display = "block"),
                            ...
                            OrgChart.events.publish("show-items", [p, { name: e }]);
                    }
                }),
